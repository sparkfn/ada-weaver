...
| v2.8.0 | Claude Agent SDK integration — third execution mode (`claude-sdk`) using Anthropic's official SDK with native tools, MCP servers, subagent delegation, budget caps | ✓ v2.8.0 |
